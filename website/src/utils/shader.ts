...
export const CAMERA_FACTOR = 180;
export const TIME_DILATION = 1 / 3;
export const BRIGHT = true;
export const DISPLACEMENT_RADIO = 1.0 / 9.0;
export const SPHERE_RADIUS = 15;

const red = new THREE.Color(1.0, 0.0, 0.0);
const magenta = new THREE.Color(0.97, 0.34, 0.45);
const cyan = new THREE.Color(0.53, 0.96, 1);
const blue = new THREE.Color(0.46, 0.32, 0.87);
const yellow = new THREE.Color(1, 0.69, 0.0);
export const COLORS = { red, magenta, cyan, blue, yellow };
...
export const buildNightGeometry = (radius: number, complexity: number) => {
...
export const initScene = (
  ...
  const mesh2 = buildShape(width, height, 2, 1 / 2, 3, -10, 1.0);
  scene.add(mesh2);
  meshes.push(mesh2);

  const mesh3 = buildShape(width, height, 1, 1 / 2.5, -2, -15, 1.0);
  scene.add(mesh3);
  meshes.push(mesh3);

  const mesh4 = buildShape(width, height, 1.5, 1 / 2, -1, -25, 1.0);
  scene.add(mesh4);
  meshes.push(mesh4);

  const mesh5 = buildShape(width, height, 1, 1 / 2.5, -6.5, -35, 1.0);
  scene.add(mesh5);
  meshes.push(mesh5);

  const mesh6 = buildShape(width, height, 2.5, 1 / 2.5, 6.5, -45, 1.0);
  scene.add(mesh6);
  meshes.push(mesh6);
